...
typealias LPPVOneTapCallback = (()->Void)?
typealias LPPVDidLoadedImageCallback = (()->Void)?
...
class LPPhotoScrollView: UIScrollView, UIScrollViewDelegate
{
    ...
    var oneTapCallback: LPPVOneTapCallback
    var didLoadedImageCallback: LPPVDidLoadedImageCallback
